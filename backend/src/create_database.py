...
# Added main execution block for direct script running (optional)
if __name__ == "__main__":
    logger.info("Running create_database script directly...")
    result = create_database()
    logger.info(f"Script finished with status: {result['status']}")
